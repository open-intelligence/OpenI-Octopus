...
{{ include "web-portal.select-labels" . }}
{{- end -}}

{{/*
Common select labels
*/}}
{{- define "web-portal.select-labels" -}}
app.kubernetes.io/name: {{ include "web-portal.name" . }}
app.kubernetes.io/instance: {{ include "web-portal.fullname" . }}
app.kubernetes.io/part-of: {{ include "web-portal.name" . }}
{{- end -}}