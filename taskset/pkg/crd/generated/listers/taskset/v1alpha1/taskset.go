...
// List lists all TaskSets in the indexer.
func (s *taskSetLister) List(selector labels.Selector) (ret []*v1alpha1.TaskSet, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.TaskSet))
	})
	return ret, err
}
...
type TaskSetNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.TaskSet, error)
	TaskSetNamespaceListerExpansion
}
...
// List lists all TaskSets in the indexer for a given namespace.
func (s taskSetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.TaskSet, err error) {
...
// Get retrieves the TaskSet from the indexer for a given namespace and name.
func (s taskSetNamespaceLister) Get(name string) (*v1alpha1.TaskSet, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("taskset"), name)
	}
	return obj.(*v1alpha1.TaskSet), nil
}
