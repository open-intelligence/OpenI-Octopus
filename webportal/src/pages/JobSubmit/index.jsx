...
class JobSubmit extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if(nextProps.gpuType !== this.props.gpuType){
            newFormInfo.gpuType = nextProps.gpuTypeMap[nextProps.gpuType]?nextProps.gpuType:'debug';
        }
        ...
        function onload(e,text){
            ...
            if(importErr.error)
            {
                ...
                if(errMsg){
                    ...
                    job.jobName = job.jobName?job.jobName.substring(0,job.jobName.length-6):"";
                    //set gpuType to 'debug' if not in gpuTypeMap.
