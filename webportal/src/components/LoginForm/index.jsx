...
import {Form, Icon, Input, Button,message,Checkbox,Tooltip,Spin} from 'antd';
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <Form.Item>
                        ...
                        <Button shape="circle">
                            ...
                            <Tooltip title={formatMessage({id:'login.from.openi'})}>
                            <a
                                target="_blank"
                                href={'/rest-server/api/v1/third/oauth/trustie/authorize'}
                            >
                                <img src={openiLogo} width="21" height="21"/>
                            </a>
                            </Tooltip>
                        </Button>
                    </Form.Item>
